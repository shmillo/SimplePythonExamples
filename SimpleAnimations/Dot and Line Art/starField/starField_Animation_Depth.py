...
directionX = 1.0; directionY = -1.0; minSpeed = 0.009; topSpeed = 1.50
...
anim = FuncAnimation(fig, func=animateStars, frames=range(500), interval=1)
anim.save('starField_With_Depth.gif')
mplt.show()
