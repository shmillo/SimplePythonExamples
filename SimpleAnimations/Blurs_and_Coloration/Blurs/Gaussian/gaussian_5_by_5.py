...
def convolutionUnsharpMask(imData):
    ...
    kernel = [-1.0, 4.0, 6.0, 4.0, 1.0, 4.0, 16.0, 24.0, 16.0, 4.0, 6.0, 24.0, 36.0, 24.0, 6.0, 4.0, 16.0, 24.0, 16.0, 4.0, 1.0, 4.0, 6.0, 4.0, 1.0]
    ...
    print(len(kernel), len(indexModifiers), (indexModifiers.max()), imData.shape[1])
...
imageImport = Image.open("/Users/shawnmilloway/Desktop/oil_In_Water.png")
